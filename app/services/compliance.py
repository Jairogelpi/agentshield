...
class ComplianceOfficer:
    async def execute_right_to_forget(
        self, tenant_id: str, target_user_id: str, requested_by: str
    ) -> dict:
        """
        ...
        cert_data = await self._generate_certificate(
            tenant_id, "RIGHT_TO_FORGET", {"original_id": target_user_id, "log": audit_log}
        )
