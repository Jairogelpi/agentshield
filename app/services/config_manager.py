...
class ConfigManager:
    ...
    async def get_val(key: str, default: Any = None) -> Any:
        ...
        try:
            ...
            def _fetch():
                return supabase.table("system_config").select("value").eq("key", key).maybe_single().execute()
    ...
    async def get_governance_defaults(self) -> Dict[str, Any]:
        return await self.get_val("governance_defaults", {
            "default_cost_center_name": "GENERIC-CC",
