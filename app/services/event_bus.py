...
class EventBus:
    async def publish(self, tenant_id: str, event_type: str, severity: str, details: dict, actor_id: str = None, trace_id: str = None):
        """
    ...
    async def _dispatch_notifications(self, tenant_id, event_type, payload):
        ...
        try:
            destinations = supabase.table("event_destinations")\
                .select("*")\
    ...
    async def _execute_playbooks(self, tenant_id, event_type, payload):
        ...
        try:
            rules = supabase.table("automation_rules")\
                .select("*")\
                .eq("tenant_id", tenant_id)\
